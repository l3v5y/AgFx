...
{
    /// <summary>
    ///     Exception type reported by the DataManager upon a failed LoadRequest.Execute call.  This will be passed to error
    ///     handlers on
    ...
    public class LoadRequestFailedException : Exception
    {
        ...
        public LoadRequestFailedException(Type objectType, LoadContext loadContext, Exception innerException)
            : base(
                "An error occurred loading an object of type " + objectType.Name + ", see InnerException for details.",
                innerException)
        {
        ...
        /// </summary>
        public LoadContext LoadContext { get; private set; }
    }
}