...
namespace AgFx
{
    ...
    public abstract class LoadRequest
    {
        ...
        // TODO: Make this a Task<LoadRequestResult> to make it easier
        /// <summary>
        ///     Execute will be called by AgFx to perform the actual load.  This call must result in an
        ///     invocation of the result action in order for a request to complete, synchrounously or asynchronously, and this
        ///     result must pass
